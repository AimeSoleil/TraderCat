...
from tradercat.core.strategy.candle_pattern.pattern_detector import PatternResult
from tradercat.core.strategy.candle_pattern.pattern_detector_orch import PatternDetectorsOrchestrator
