...
"""
    ...
    pipeline_max_concurrency: int = Field(default=2, description="Max concurrent workers")
    pipeline_audit_batch_size: int = Field(default=2, description="P3a: symbols per gate audit batch")
    pipeline_exec_batch_size: int = Field(default=2, description="P3b: symbols per execution plan batch")
