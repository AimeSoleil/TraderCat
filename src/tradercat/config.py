...
"""
    ...
    pipeline_audit_batch_size: int = Field(default=5, description="P3a: symbols per gate audit batch")
    ...
    llm_progress_interval: float = Field(default=30.0, description="Seconds between LLM progress updates")
