...
class DragonflyDojiDetector(SingleCandlePatternDetector):
    ...
    def detect(self, open_, high, low, close, *, atr: Optional[float] = None, **overrides) -> PatternResult:
        ...
        # ATR-adaptive tiny body threshold
        ...
        is_pattern = body_ok and lower_ok and upper_ok  # noqa: pseudo
        is_pattern = body_ok and lower_ok and upper_ok  # actual
        ...
        metrics = {
            ...
            "body_ok": body_ok, "lower_ok": lower_ok, "upper_ok": upper_ok,
            "open": open_, "close": close, "high": high, "low": low,
            "params": self.defaults | {"atr": atr} | overrides,
        }
        return PatternResult(True, "Dragonfly Doji", "neutral", metrics)
